...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO products (name, sku, category, price, quantity, description, status, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssdiss", $name, $sku, $category, $price, $quantity, $description, $status, $image);
...
<head>
    ...
    <title>Add Product - XY_SHOP</title>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    ...
                                    <option value="Men's Clothing" <?php echo (isset($_POST['category']) && $_POST['category'] == "Men's Clothing") ? 'selected' : ''; ?>>Men's Clothing</option>
                                    <option value="Women's Clothing" <?php echo (isset($_POST['category']) && $_POST['category'] == "Women's Clothing") ? 'selected' : ''; ?>>Women's Clothing</option>
